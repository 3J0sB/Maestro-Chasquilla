    ...
    <div className="overflow-x-auto">
      <div className="flex space-x-4 pb-3 pt-1 px-2 min-w-max">
        {categories.map((category) => (
          ...
          >
            <div
              className={`flex justify-center items-center w-14 h-14 rounded-full mb-1 ${active === category.id
                ? 'bg-orange-500'
            ...
            <span className={`text-xs text-center line-clamp-1 ${active === category.id ? 'text-orange-500 font-medium' : 'text-gray-600'
              }`}>
              {category.name}
            </span>
          </Link>
