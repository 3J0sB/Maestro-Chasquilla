...
import MessageModal from '@/components/layout/consumer-components/provider-profile/message-modal';
          ...
          role === 'USER' && (
            <div className="mt-4 md:mt-0 flex flex-col gap-2">
              <button 
                ...
                className="bg-white border cursor-pointer border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-orange-500 hover:text-orange-500 font-medium rounded-lg px-4 py-2 flex items-center justify-center transition-colors"
              >
